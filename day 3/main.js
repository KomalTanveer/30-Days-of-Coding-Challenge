...
console.log(removeDuplicates([1, 1, 4, 4, 6, 8, 4])); // Output: [1, 2, 3, 4, 5]
console.log(removeDuplicates([10, 70, 50, 90, 60, 50])); // Output: [10, 20, 30, 40]
console.log(removeDuplicates([8, 8, 8, 8, 8])); // Output: [1]
